...
// ─────────────────────────────────────────────
function flagConsecutiveDuplicates(text) {
...
export async function transcribeAudio(audioBuffer) {
    ...
    try {
        const response = await openai.audio.transcriptions.create({
            ...
            prompt: 'Dear Sirs, Yours faithfully, witness statement, claimant, quantum, accident circumstances, opinion, recommendation, enclosures, time sheet, client interviewed, we are pleased to confirm, inspector, claim technician, solicitors, postcode, reference',
        });
